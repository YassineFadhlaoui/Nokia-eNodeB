                            ...
                            <table class="table table-hover table-bordered" id="sampleTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th> <i class="fas fa-cogs"></i> VLAN IP</th>
                                        <th> <i class="fas fa-location-arrow"></i> Vlan Mac</th>
                                        <th> <i class="fas fa-flag"></i> Management IP</th>
                                        <th> <i class="fas fa-location-arrow"></i> Management Mac</th>
                                ...
                                <tbody>
                                    <c:forEach items="${VLANs}" var="vlan">
                                        <tr>
                                    <td><center><c:out value="${vlan.vlan.name}"/></center></td>
                                    <td><center><c:out value="${vlan.vlan.segmentationID}"/></center></td>
                                    <td><center><c:out value="${vlan.instance.vlanInterrface.ipAddress}"/></center></td>
                                    <td><center><c:out value="${vlan.instance.vlanInterrface.macAddress}"/></center></td>
                                    <td><center><c:out value="${vlan.instance.managementInterrface.ipAddress}"/></center></td>
                                    <td><center><c:out value="${vlan.instance.managementInterrface.macAddress}"/></center></td>
